    ...
    <div v-else>
      <div class="row">
        <div class="col-12 col-md-4 mb-3">
          ...
          <label class="fw-bold">Order Total:</label>
        ...
        <div class="col-12 col-md-4 mb-3">
          ...
          <label class="fw-bold">Line 1:</label>
          <div class="ms-2 mb-2">
            {{ order.customer.billing_address.line_1 }}
          </div>
          <div v-if="order.customer.billing_address.line_2">
            <label class="fw-bold">Line 2:</label>
            <div class="ms-2 mb-2">
              {{ order.customer.billing_address.line_2 }}
            </div>
          </div>
          <label class="fw-bold">City:</label>
          ...
          <label class="fw-bold">Zip Code:</label>
          <div class="ms-2 mb-2">
            {{ order.customer.billing_address.postal_code }}
          </div>
        </div>
      </div>
                  ...
                  formatPrice(
                    parseFloat(item.base_price) +
                      item.variations.reduce(
                        (prev, variation) =>
                          prev + parseFloat(variation.price_modifier),
                        0
                      )
                  )
                }}
      ...
      <div class="d-flex justify-content-end mb-2">
        <button class="btn btn-info me-2" @click="openShipModal">
